...
import kr.co.fastcam.eatgo.application.ReservationService;
import kr.co.fastcam.eatgo.domain.Reservation;
...
public class ReservationControllerTests {
    ...
    public void list() throws Exception {
        ...
        verify(reservationService).getReservations(1004L);  //레스토랑 아이디 1004
    }
